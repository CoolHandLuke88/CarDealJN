...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    {
        self.meteor = [AppDelegate appDelegate].meteorClient;
        self.lists = self.meteor.collections[@"lists"];
        
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(setMeteorParams) name:LoginSuccessNotification object:nil];
    }
...
- (void)logout {
    [self.meteor logout];
    [[AppDelegate appDelegate] showLogin];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (list[@"name"]) controller.listName = list[@"name"];
